...
const TEXTS = {
  ...
  ar: {
    ...
    footnote: 'تفترض الحسابات متوسط ٣٠.٤ يومًا في الشهر؛ تسعير الإيجار قصير الأجل يتطابق مع شروط العقود الشهرية.'
  }
};
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center bg-purple-50/50 p-3.5 rounded-xl border border-purple-100/50">
                <div>
                  ...
                  <span className="text-xs text-gray-500">{isRTL ? 'نوفمبر إلى مارس' : 'November to March'}</span>
                </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-100 text-gray-400 font-bold">
                  ...
                  <th className="py-2.5 text-center font-bold text-xs uppercase tracking-wider text-purple-600">{t.oneBR}</th>
          ...
          <table className="w-full text-xs sm:text-sm text-gray-600 text-center">
            ...
            <tfoot>
              <tr className="border-t-2 border-gray-900 bg-gray-900 text-white font-bold text-xs sm:text-sm">
                ...
                <td className="py-4 px-2 font-black tabular-nums">20</td>
